...
Salve sua resposta em um arquivo chamado answer.csv com duas colunas: `NU_INSCRICAO` e `IN_TREINEIRO`.# codenation-desafio-9
Desafio Codenation Aceleradev Data Science nono módulo
